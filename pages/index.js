  ...
  return (
    <div className={styles.container}>
      ...
      <main className={styles.main}>
        ...
        <div className={styles.grid}>
          <a href="https://meloinu.netlify.app" className={styles.card}>
            <Image src="/resources/GitHub-Mark-64px.png" alt="LinkFit Logo" width={64} height={64}/>            
            <h2>Melo Inu | Home &rarr;</h2>
      ...
      <footer className={styles.footer}>
        ...
        >
          ...
          <span className={styles.logo}>
            <Image src="/melo.ico" alt="Melo Logo" width={72} height={16} />
          </span>
        </a>
      </footer>
    </div>
